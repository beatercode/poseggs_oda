                                ...
                                <div class="card-header card-header-nft-image-buy card-header-desctop">
                                    <div class="slider-nft-wrap">
                                        <ul class="ul-our-nfts" :class="'ul-binance'">
                                            <li v-for="(price, index) of pricesLootbox"
                                                @click="setSelectedLoot(price, index)"
                                                ...
                                                <div class="rarity-label-title" style="margin-bottom: 8px;"
                                                    :class="getRarityClassNameByIndex(index)">
                                                    {{ getNameFromIndex(index) }}
                                                </div>
                                                <div class="li-our-nft-wrap">
                                                    <!--img class="card-egg-image-img nft-loot-add-1"
                                                        :src="getNftImage(5)" />
                                                    <img class="card-egg-image-img nft-loot-add-2"
                                                        :src="getNftImage(6)" />
                                                        ...
                                                        <div style="width: 100%">
                                                            ...
                                                            <div>
                                                                <div class="stake-nft-value-main-stats-loot">
                                                                    ...
                                                                    <span class="lootbox-main-stat-col">{{
                                                                            !isNumberEq(index, 3) ? "0.03%" : "-"
                                                                    }}</span>
                                                                </div>
                                                                <div class="stake-nft-value-main-stats-loot">
                                                                    <span class="lootbox-main-stat-col"
                                                                        :class="getClassOnTier(+index * 2 + 4)">{{
                                                                                !isNumberEq(index, 3) ? ("TIER ".concat(index *
                                                                                    2 + 4)) : "Soon"
                                                                        }}</span>
                                                                    <span class="lootbox-main-stat-col">{{
                                                                            getEggValue(+index * 2 + 4)
                                                                    }}</span>
                                                                    <span class="lootbox-main-stat-col">{{
                                                                            !isNumberEq(index, 3) ? "0.3%" : "-"
                                                                    }}</span>
                                                                </div>
                                                                <div class="stake-nft-value-main-stats-loot">
                                                                    <span class="lootbox-main-stat-col"
                                                                        :class="getClassOnTier(+index * 2 + 3)">{{ index
                                                                                == 3 ? "BONUS" : ("TIER ".concat(index * 2 + 3))
                                                                        }}</span>
                                                                    <span class="lootbox-main-stat-col">{{
                                                                            getEggValue(+index * 2 + 3)
                                                                    }}</span>
                                                                    <span class="lootbox-main-stat-col">{{ "3%"
                                                                    }}</span>
                                                                </div>
                                                                <div class="stake-nft-value-main-stats-loot">
                                                                    <span class="lootbox-main-stat-col"
                                                                    ...
                                                                    <span class="lootbox-main-stat-col">{{ "20%"
                                                                    }}</span>
                                                                </div>
                                                                <div class="stake-nft-value-main-stats-loot">
                                                                    <span class="lootbox-main-stat-col"
                                                                    ...
                                                                    <span class="lootbox-main-stat-col">{{ "56.7%"
                                                                    }}</span>
                                                                </div>
                                                                <div class="stake-nft-value-main-stats-loot">
                                                                    <span class="lootbox-main-stat-col"
                                                    ...
                                                    <div class="mint-nft-block" style="margin-top: 0px;">
                                                        <button v-if="isApproved(index)" :disabled="showLoader"
                                                            @click="BuyLOOTBOX(index)" class="btn btn-mint">
                                                            {{ translatesGet("MINT") }}
                                                        </button>
                                                        <button v-if="!isApproved(index)" :disabled="showLoader"
                                                                ...
                                                                <div>
                                                                    <div class="stake-nft-value-main-stats-loot">
                                                                        <span class="lootbox-main-stat-col-mob"
                                                                            :class="getClassOnTier(+index * 2 + 5)">{{
                                                                                    index == 2 ? "BONUS" : !isNumberEq(index, 3)
                                                                                        ? ("TIER ".concat(index * 2 + 5)) : "Soon"
                                                                            }}</span>
                                                                    ...
                                                                    <div class="stake-nft-value-main-stats-loot">
                                                                        <span class="lootbox-main-stat-col-mob"
                                                                            :class="getClassOnTier(+index * 2 + 3)">{{
                                                                                    index == 3 ? "BONUS" : ("TIER ".concat(index
                                                                                        * 2 + 3))
                                                                            }}</span>
                                                                        <!--span class="lootbox-main-stat-col">{{ getEggValue(+index*2 + 3) }}</span-->
                                                                        <span class="lootbox-main-stat-col-mob">{{ "3%"
                                                                        }}</span>
                                                                    </div>
                                                                    <div class="stake-nft-value-main-stats-loot">
                                                                        <span class="lootbox-main-stat-col-mob"
