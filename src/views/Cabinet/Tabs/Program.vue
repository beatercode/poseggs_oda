            ...
            <div class="cab-row-card section-wrap-blocks">
                ...
                <div v-if="currentAddress && currentAddress !== '0x0000000000000000000000000000000000000000'"
                    ...
                    <div class="copy-ref-link">
                        ...
                        <button v-clipboard="setReferralLink" v-clipboard:success="copySuccess"
                            v-clipboard:error="copyFailed" class="btn btn-copy-ref btn-light">
                            {{ buttonText }}
                        </button>
                    </div>
                    <div v-if="userRefData && userRefData.referrer != '0x0000000000000000000000000000000000000000'"
                        class="wrap-sponsor">
                        <div class="title-sponsor">{{ translatesGet("YOUR_SPONSOR") }}</div>
                        <a :href="`https://bscscan.com/address/${userRefData ? userRefData.referrer : ''}`"
                            target="_blank">
                            <div class="link-sponsor">{{ addressShort(userRefData ? userRefData.referrer : "", 5, 3) }}
                                <i class="icon-share"></i>
                            </div>
                        </a>
                    </div>
                    <button v-clipboard="setReferralLink" v-clipboard:success="copySuccess"
                        v-clipboard:error="copyFailed" class="btn btn-copy-ref btn-copy-ref-mobile btn-light">
                        {{ buttonText }}
                    </button>
                </div>
            </div>
            ...
            <div class="cab-row-card general-info-card general-info-card-program">
                <div class="general-card team">
                    <div class="general-card-col">
                        ...
                        <span class="h4" style="white-space: nowrap;">{{ userRefData && userRefData.referralsNumber > 0
                                ? userRefData.referralsNumber : 0
                        }}</span>
                    </div>
                </div>
                ...
                <div class="general-card lvl">
                    <div class="general-card-col">
                        ...
                        <span class="h4" style="white-space: nowrap;">{{ getRefPercent }} %</span>
                    </div>
                </div>
                ...
                <div class="cab-row-card">
                    <div class="cab-card-wrap stake-card">
                        <div class="card-header">
                            <div style="filter: hue-rotate(316deg) invert(1);" class="card-header-icon header-crown">
                            </div>
                            <div>
                                <div class="h4">{{ translatesGet("REF_PROG_COMING_SOON") }}</div>
                                <div class="h5">
                                    {{ translatesGet("REF_PROG_DESCR_COMING_SOON") }}
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="structure-table structure-table-ref">
                                <div class="structure-table-col structure-table-col-name">
                                    ...
                                    <div class="structure-row structure-row-text">{{
                                            translatesGet("STRUCTURE_ROW_NAME_6")
                                    }}</div>
                                    <div class="structure-row structure-row-progress">{{
                                            translatesGet("STRUCTURE_ROW_NAME_4")
                                    }}</div>
                                </div>
                                <div class="structure-table-col structure-table-col-data">
                                    <div class="col-data" :class="getRefLevelClass(1)" :style="{
                                        '--progressValue':
                                    ...
                                    <div class="col-data" :class="getRefLevelClass(2)" :style="{
                                        '--progressValue':
                                    ...
                                    <div class="col-data" :class="getRefLevelClass(3)" :style="{
                                        '--progressValue':
                                    ...
                                    <div class="col-data" :class="getRefLevelClass(4)" :style="{
                                        '--progressValue':
                                    ...
                                    <div class="col-data" :class="getRefLevelClass(5)" :style="{
                                        '--progressValue':
                                    ...
                                    <div class="col-data" :class="getRefLevelClass(6)" :style="{
                                        '--progressValue':
                                    ...
                                    <div class="col-data" :class="getRefLevelClass(7)" :style="{
                                        '--progressValue':
                                    ...
                                    <div class="col-data" :class="getRefLevelClass(8)" :style="{
                                        '--progressValue':
                ...
                <div class="cab-row-card">
                    <div class="cab-card-wrap stake-card">
                        <div class="card-header">
                            ...
                            <button v-if="userRefData && !userRefData.isLeader" @click="showLeadModal = true"
                                class="btn btn-become btn-light">
                            ...
                            " disabled class="btn btn-leader">
                                {{ translatesGet("YOU_ARE_LEAD") }}
                            </button>
                        </div>
                        <div class="section-row-reward"
                            v-if="currentAddress && currentAddress !== '0x0000000000000000000000000000000000000000'">
                            <div v-if="userLeaderData && userLeaderData.leaderLevel === 0"
                                class="block-reward block-reward-link">
                            ...
                            <div v-else-if="userLeaderData && userLeaderData.leaderLevel > 0" class="block-reward">
                                ...
                                <div class="reward-boost-wrap"
                                    :class="isClaimed(userLeaderData && userLeaderData.leaderLevel)">
                                    <div class="img-wrap"
                                        :class="isClaimed(userLeaderData && userLeaderData.leaderLevel)">
                                    ...
                                    <div class="data-wrap">
                                        <div class="title">
                                            ...
                                            {{ userLeaderData && userLeaderData.leaderLevel ? userLeaderData.leaderLevel
                                                    : 0
                                            }}
                                        </div>
                                        <div class="card-boost-data">
                                            <div class="boost-data-item boost-data-item-7">
                                                ...
                                                {{ userLeaderData && userLeaderData.leaderProfitPerc ? "+" +
                                                        userLeaderData.leaderProfitPerc : "0"
                                                }}%
                                            </div>
                                            <div class="boost-data-item boost-data-item-7">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                ...
                                                {{ userLeaderData && userLeaderData.leaderTimePerc > 0 ? "+" +
                                                        userLeaderData.leaderTimePerc : "0"
                                                }}%
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div v-if="userLeaderData && userLeaderData.leaderLevel < 10" class="block-reward">
                                ...
                                <div class="reward-boost-wrap">
                                    <div class="img-wrap"
                                        :class="isClaimed(userLeaderData && userLeaderData.leaderLevel + 1)">
                                    ...
                                    <div class="data-wrap">
                                        <div class="title">
                                            ...
                                            LVL
                                            {{ userLeaderData && userLeaderData.leaderLevelNext ?
                                                    userLeaderData.leaderLevelNext : 0
                                            }}
                                        </div>
                                        <div class="card-boost-data">
                                            <div class="boost-data-item boost-data-item-8">
                                                ...
                                                {{
                                                        userLeaderData && userLeaderData.leaderProfitPercNext > 0 ? "+" +
                                                            userLeaderData.leaderProfitPercNext : "1"
                                                }}%
                                            </div>
                                            <div class="boost-data-item boost-data-item-8">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                ...
                                                {{ userLeaderData && userLeaderData.leaderTimePercNext > 0 ? "+" +
                                                        userLeaderData.leaderTimePercNext : "0"
                                                }}%
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="section-row-structure">
                            <div class="structure-header">
                                ...
                                <div v-if="userLeaderData && userLeaderData.isDefRef === false" class="h5">{{
                                        translatesGet("PROGRESS_LEAD_DESCRIBE_1")
                                }}</div>
                            ...
                            <div class="structure-main-data">
                                <div class="col">
                                    ...
                                    <div class="value">{{ userLeaderData && userLeaderData.referralsNumber ?
                                            userLeaderData.referralsNumber : "0"
                                    }}</div>
                                </div>
                                <div class="col">
                            ...
                            <div class="structure-table structure-table-lead">
                                <div class="structure-table-col structure-table-col-name">
                                    ...
                                    <div class="structure-row structure-row-text">{{
                                            translatesGet("STRUCTURE_ROW_NAME_3")
                                    }}</div>
                                    <div class="structure-row structure-row-progress">{{
                                            translatesGet("STRUCTURE_ROW_NAME_4")
                                    }}</div>
                                    <div class="structure-row structure-row-img">{{
                                            translatesGet("STRUCTURE_ROW_NAME_5")
                                    }}</div>
                                </div>
                                <div class="structure-table-col structure-table-col-data">
...
export default {
    ...
    methods: {
        getStats(level) {
            ...
            } else if (this.isRefProgram && (!this.currentBlockchain || this.currentBlockchain === 43114 || this.currentBlockchain === 43113)) {
                const obj = conf[this.currentBlockchain || 43114].REF_RULES.find((el) => el.level === level);
                return [obj.turnover, obj.referrals];
            }
        },
        translatesGet(key) {
