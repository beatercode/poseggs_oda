<template>
    <div>
        ...
        <transfer-modal v-if="showTransferModal" nftType="Boost" :nft="selectedNft"
            @close="(showTransferModal = false), (selectedNft = null), (onlyData = false)" :onlyData="onlyData" />
        <main class="main-boosts">
            ...
            <div class="cab-col-wrap">
                    ...
                    <section class="cab-row" id="section-boosts-team">
                        <div class="cab-row-card">
                            <div class="cab-card-wrap boosts-card">
                                ...
                                <div class="boosts-card-content">
                                    <div class="blocks-percent-wrap">
                                        <boost-card :disableChildLoader="disableChildLoader" type="team"
                ...
                <div v-if="false" class="cab-col cab-minor-col">
                                ...
                                <div v-else class="your-boosts">
                                    <div class="your-boost-item" v-for="nft of getNftBoost()">
                                        <div class="block-percent-img">
                                            <div class="your-nft-img" :class="getClassImg(nft)"
                                        ...
                                        <div class="block-percent-content">
                                            <div class="btns-container">
                                                <button @click="$router.push({ name: 'YourStake' })"
                                                    class="btn btn-use">
                                                    {{ translatesGet("BTN_USE") }}
                                                </button>
                                                <button @click="(showTransferModal = true), (selectedNft = nft)"
