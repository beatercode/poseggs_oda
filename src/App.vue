    ...
    mounted() {
        ...
        setTimeout(async function init() {
            try {
                ...
                const data = { "56": { "NFT": { "totalNftsSold": 15, "totalAmountSoldNft": 1222, "uniqueUsers": 2 }, "STAKE": { "refTotalTurnover": 213 } }, "97": { "NFT": { "totalNftsSold": 15, "totalAmountSoldNft": 1241122, "uniqueUsers": 2 }, "STAKE": { "refTotalTurnover": 23423 } } };
